...
internal class ControladorCampeones : Estructurable
{
    ...
    //anadir campeon magico
    public void anadirCampeonMagico()
    {
        CampeonMagico c = new CampeonMagico();
        Console.WriteLine("Introduce el nombre del campeon: ");
        c.Nombre = Console.ReadLine();
        Console.WriteLine("Introduce la vida del campeon: ");
        c.Vida = Int32.Parse(Console.ReadLine());
        Console.WriteLine("Introduce el mana del campeon: ");
        c.Mana = Int32.Parse(Console.ReadLine());

        //Pasiva
        HabilidadPasiva pasiva = new HabilidadPasiva();
        Console.WriteLine("Introduce el nombre de su habilidad pasiva: ");
        pasiva.Nombre = Console.ReadLine();
        Console.WriteLine("Introduce una descripcion de su pasiva: ");
        pasiva.Descripcion = Console.ReadLine();
        Console.WriteLine("Introduce el enfriamiento de su pasiva: ");
        pasiva.Enfriamiento = Double.Parse(Console.ReadLine());

        c.Pasiva = pasiva;//añadimos la pasiva
        //No añado la foto porque aun no lo vamos a usar
        Console.WriteLine("Introduce el daño del campeon: ");
        c.DanioAP = Int32.Parse(Console.ReadLine());

        this.Campeones.Add(c);


    }
    //anadir campeon fisico
    public void anadirCampeonFisico()
    {
        CampeonFisico c = new CampeonFisico();
        Console.WriteLine("Introduce el nombre del campeon: ");
        c.Nombre = Console.ReadLine();
        Console.WriteLine("Introduce la vida del campeon: ");
        c.Vida = Int32.Parse(Console.ReadLine());
        ...
        //No añado la foto porque aun no lo vamos a usar
        Console.WriteLine("Introduce el daño del campeon: ");
        c.DanioAD = Int32.Parse(Console.ReadLine());
    ...
    public void mostrarCampeones()
    {
        foreach (Campeon c in Campeones)
        {
    ...
    //borrar campeon (Listarlos todos)
    public void borrarCampeon()
    {
        //mostramos los campeones
        Console.WriteLine("Seleciona que campeon quieres eliminar: ");
        int i = 1;
        //les añado un numero con su posicion para eliminarlos de la lista
        foreach (Campeon c in Campeones)
        {
            Console.Write($"{i}- ");
            Console.WriteLine(c.ToString());
        ...
        Console.WriteLine("Dime la posicion del campeon: ");
        int pos = Int32.Parse(Console.ReadLine());

        //Eliminamos de la lista al campeon seleccionado
        //Añadimos el -1 porque los muestro empezando desde 1 en lugar de 0
        if (Campeones.Count > 1) {
            Campeon cam = Campeones[pos - 1];
            Campeones.RemoveAt(pos - 1);
        }
